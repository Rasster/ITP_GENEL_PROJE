...
namespace OtelMvcProje.Models.Entity
{
    ...
    public partial class DbOtelYeniEntitiess : DbContext
    {
        public DbOtelYeniEntitiess()
            : base("name=DbOtelYeniEntitiess")
        {
        }
        ...
        public virtual DbSet<TblRezevasyon> TblRezevasyon { get; set; }
